...
For an implementation of this formula it is important to note that the involved multinomial coefficients may be derived from a single initial coefficient.
Consider

<div>
$$
|\mathcal{P}(M)| = {n \choose m_{1},m_{2},\ldots ,m_{l}} = {\frac {n!}{m_{1}!\,m_{2}!\,\cdots \,m_{l}!}}
$$
</div>
and for $$i \in M$$
<div>
$$
|\mathcal{P}(M \setminus \{i\})| = {n - 1 \choose m_{1},m_{2},\ldots m_{i} - 1,\ldots ,m_{l}} = {\frac {(n - 1)!}{m_{1}!\,m_{2}!\,\cdots \,(m_{i} - 1)!\,\cdots \,m_{l}!}}
= {\frac{m_i |\mathcal{P}(M)|}{n}}
$$
</div>
